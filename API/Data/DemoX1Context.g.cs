...
using DemoX1.Entities;

namespace DemoX1.Data
{
    /// <summary>
    /// Represents the database context for the application.
    /// </summary>
    public class DemoX1Context : DbContext
    {
        /// <summary>
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=codezen.database.windows.net;Initial Catalog=T976123_DemoX1;Persist Security Info=True;user id=Lowcodeadmin;password=NtLowCode^123*;Integrated Security=false;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=true;");
        }
