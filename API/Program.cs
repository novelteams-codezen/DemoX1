...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "DemoX1", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<DemoX1Context>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "DemoX1 API v1");
